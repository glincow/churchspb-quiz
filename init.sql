...
(1, 'ПИР ЛЮБВИ', 'Если нужное количество блюд набрано, а вы всё равно хотели бы принести <b>салат, или мясное, или гарнир,</b> то используйте <b>«Другое»,</b> чтобы добавить то, что вы хотите принести.', 'Ниже напишите ваше имя');
...
(26, 1, 'Хурма/королёк – 1 кг', 'ch', 9, 2, NULL, ''),
